...
agent-team job start|stop|kill [--step <id>]|wait|logs [--step <id>] [--last-message|--clean]|attach [--step <id>]|send [--step <id>]|unblock|update|hold|release|timeout [--all --pipeline name --target-agent worker] [--message "..."] [--message-file <path|->]|close [--message "..."]|cancel [--step <id> --stop|--kill]|adopt|reopen|rm|prune|reconcile ...
