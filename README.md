...
agent-team pipeline drain <pipeline> [--interval 2s] [--max-cycles N] [--skip-drain] [--skip-advance] [--all-ready-steps] [--limit N] [--workspace auto|worktree|repo] [--runtime claude|codex] [--runtime-bin <path>] [--wait [--wait-status running|terminal] [--wait-timeout 5m] [--fail-on-failed]] [--format '{{.Pipeline}} {{.Idle}}'] [--json]
