...
agent-team job adopt <job-id> --instance <name> --pid <pid> [--runtime claude|codex] [--session-id <id>] [--dry-run] [--format '{{.Job.ID}} {{.Metadata.Instance}}'] [--json]
