...
agent-team team ls [--json] | show <team> [--json] | ps <team> [-w] [--no-clear] [--interval 2s] [--json] | jobs <team> [--status running] [--sort updated] [--format '{{.ID}}'] [--json] | status <team> [-w] [--no-clear] [--interval 2s] [--json]
