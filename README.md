...
Pipeline and team job tables support live refresh with `pipeline jobs <pipeline> --watch` and `team jobs <team> --watch`; add `--summary`, `--no-clear`, or `--interval 5s` for aggregate operator dashboards.
