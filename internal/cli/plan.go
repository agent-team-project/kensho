...
func newPlanCmd() *cobra.Command {
	...
	cmd.Flags().StringSliceVar(&runtimeFilters, "runtime", nil, "Only show daemon-known plan rows for this runtime: claude, codex, or docker. Can repeat or comma-separate.")
