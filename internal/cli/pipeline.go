...
func newPipelineJobsCmd() *cobra.Command {
	...
	cmd.Flags().StringSliceVar(&runtimeFilters, "runtime", nil, "Only show jobs whose instance metadata has this runtime: claude, codex, or docker. Can repeat or comma-separate.")
...
func newPipelineRuntimeLsCmd() *cobra.Command {
	...
	cmd.Flags().StringSliceVar(&runtimeFilters, "runtime", nil, "Only show pipeline-owned metadata for this runtime: claude, codex, or docker. Can repeat or comma-separate.")
...
func newPipelineSendCmd() *cobra.Command {
	...
	cmd.Flags().StringSliceVar(&runtimeFilters, "runtime", nil, "Send to pipeline-owned instances for this runtime: claude, codex, or docker. Can repeat or comma-separate.")
...
func newPipelinePsCmd() *cobra.Command {
	...
	cmd.Flags().StringSliceVar(&runtimeFilters, "runtime", nil, "Only show pipeline-owned instances for this runtime: claude, codex, or docker. Can repeat or comma-separate.")
...
func newPipelineLogsCmd() *cobra.Command {
	...
	cmd.Flags().StringSliceVar(&runtimes, "runtime", nil, "Only show logs for pipeline-owned instances for this runtime: claude, codex, or docker. Can repeat or comma-separate.")
...
func newPipelineEventsCmd() *cobra.Command {
	...
	cmd.Flags().StringSliceVar(&runtimeFilters, "runtime", nil, "Only show pipeline events for daemon-known instances for this runtime: claude, codex, or docker. Can repeat or comma-separate.")
...
func pipelineGraphFromTopology(top *topology.Topology, pipeline *topology.Pipeline, includeRoutes bool) pipelineGraph {
	...
	for _, step := range pipeline.Steps {
		...
		node := pipelineGraphNode{
			...
			Effort:           strings.TrimSpace(step.Effort),
