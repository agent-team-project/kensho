...
func TestLifecycleHelpShowsTopLevelStartStop(t *testing.T) {
	...
	for _, want := range []string{
		"start", "stop", "kill", "restart", "reload", "plan", "sync", "status", "health", "monitor", "watch", "inspect", "rm", "prune", "wait", "stats", "send", "dispatch", "job", "pipeline", "schedule", "queue", "intake", "events", "ps", "logs", "attach",
