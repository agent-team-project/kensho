...
func newTeamRuntimeLsCmd() *cobra.Command {
	...
	cmd.Flags().StringSliceVar(&runtimeFilters, "runtime", nil, "Only show team-owned metadata for this runtime: claude, codex, or docker. Can repeat or comma-separate.")
...
func newTeamRuntimeResumePlanCommand(cfg teamRuntimeResumePlanCommandConfig) *cobra.Command {
	...
	cmd.Flags().StringSliceVar(&runtimeFilter, "runtime", nil, "Only include metadata for this runtime: claude, codex, or docker. Can repeat or comma-separate.")
...
func newTeamPsCmd() *cobra.Command {
	...
	cmd.Flags().StringSliceVar(&runtimeFilters, "runtime", nil, "Only show team-owned instances for this runtime: claude, codex, or docker. Can repeat or comma-separate.")
...
func newTeamJobsCmd() *cobra.Command {
	...
	cmd.Flags().StringSliceVar(&runtimeFilters, "runtime", nil, "Only show team-owned jobs whose instance metadata has this runtime: claude, codex, or docker. Can repeat or comma-separate.")
...
func newTeamQueueCmd() *cobra.Command {
	...
	cmd.Flags().StringSliceVar(&runtimes, "runtime", nil, "Filter by queued dispatch runtime: claude, codex, or docker. Can repeat or comma-separate.")
...
func newTeamQueueRetryCmd() *cobra.Command {
	...
	cmd.Flags().StringSliceVar(&eventTypes, "event-type", nil, "With --all, filter by event type; repeat or comma-separate values.")
	cmd.Flags().StringSliceVar(&jobs, "job", nil, "With --all, filter by job id or ticket; repeat or comma-separate values.")
	cmd.Flags().StringSliceVar(&runtimes, "runtime", nil, "With --all, filter by queued dispatch runtime: claude, codex, or docker. Can repeat or comma-separate.")
...
func newTeamQueuePruneCmd() *cobra.Command {
	...
	cmd.Flags().StringSliceVar(&runtimes, "runtime", nil, "Filter by queued dispatch runtime before pruning: claude, codex, or docker. Can repeat or comma-separate.")
...
func newTeamLogsCmd() *cobra.Command {
	...
	cmd.Flags().StringSliceVar(&runtimes, "runtime", nil, "Only show logs for team-owned instances for this runtime: claude, codex, or docker. Can repeat or comma-separate.")
...
func newTeamEventsCmd() *cobra.Command {
	...
	cmd.Flags().StringSliceVar(&runtimeFilters, "runtime", nil, "Only show team events for daemon-known instances for this runtime: claude, codex, or docker. Can repeat or comma-separate.")
...
func newTeamSendCmd() *cobra.Command {
	...
	cmd.Flags().StringSliceVar(&runtimeFilters, "runtime", nil, "Send to team-owned instances for this runtime: claude, codex, or docker. Can repeat or comma-separate.")
...
func newTeamWaitCmd() *cobra.Command {
	...
	cmd.Flags().StringSliceVar(&runtimeFilters, "runtime", nil, "Wait for team-owned instances for this runtime: claude, codex, or docker. Can repeat or comma-separate.")
...
func newTeamPruneCmd() *cobra.Command {
	...
	cmd.Flags().StringSliceVar(&runtimeFilters, "runtime", nil, "Only remove matching team-owned instances for this runtime: claude, codex, or docker. Can repeat or comma-separate.")
...
func newTeamRepairCmd() *cobra.Command {
	...
	cmd.Flags().StringVar(&runtimeKind, "runtime", "", "Runtime profile for retried or advanced team step dispatches (claude, codex, or docker). Overrides env and repo config.")
...
func newTeamUpCmd() *cobra.Command {
	...
	cmd.Flags().StringSliceVar(&runtimeFilters, "runtime", nil, "Only target team-owned daemon-known instances for this runtime: claude, codex, or docker. Can repeat or comma-separate.")
	cmd.Flags().BoolVarP(&quiet, "quiet", "q", false, "Suppress non-error output and use only the exit code.")
	cmd.Flags().BoolVar(&jsonOut, "json", false, "Emit machine-readable JSON.")
...
func newTeamSyncCmd() *cobra.Command {
	...
	cmd.Flags().StringSliceVar(&runtimeFilters, "runtime", nil, "Only sync team-owned daemon-known plan rows for this runtime: claude, codex, or docker. Can repeat or comma-separate.")
...
func newTeamPlanCmd() *cobra.Command {
	...
	cmd.Flags().StringSliceVar(&runtimeFilters, "runtime", nil, "Only show team-owned daemon-known plan rows for this runtime: claude, codex, or docker. Can repeat or comma-separate.")
...
func newTeamHealthCmd() *cobra.Command {
	...
	cmd.Flags().StringSliceVar(&runtimeFilters, "runtime", nil, "Only check team-owned daemon-known instances for this runtime: claude, codex, or docker. Daemon, queue, and job health remain team-scoped. Can repeat or comma-separate.")
...
func newTeamStatusCmd() *cobra.Command {
	...
	cmd.Flags().BoolVar(&commands, "commands", false, "Print recommended actions, one per line. agent-team follow-ups preserve the selected repo scope.")
	cmd.Flags().StringSliceVar(&runtimeFilters, "runtime", nil, "Only summarize team-owned instances for this runtime: claude, codex, or docker. Jobs, queue, pipelines, and schedules remain team-scoped. Can repeat or comma-separate.")
...
func newTeamMonitorCmd() *cobra.Command {
	...
	cmd.Flags().StringSliceVar(&runtimeFilters, "runtime", nil, "Only show team-owned instances for this runtime in instance, stats, and plan sections: claude, codex, or docker. Can repeat or comma-separate.")
