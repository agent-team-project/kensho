...
func newStartCmd() *cobra.Command {
	...
	cmd.Flags().StringSliceVar(&runtimeFilters, "runtime", nil, "Only start or resume daemon-known instances for this runtime: claude, codex, or docker. Can repeat or comma-separate.")
...
func newStopCmd() *cobra.Command {
	...
	cmd.Flags().StringSliceVar(&runtimeFilters, "runtime", nil, "Only stop running daemon-known instances for this runtime: claude, codex, or docker. Can repeat or comma-separate.")
...
func newKillCmd() *cobra.Command {
	...
	cmd.Flags().StringSliceVar(&runtimeFilters, "runtime", nil, "Only force-stop running daemon-known instances for this runtime: claude, codex, or docker. Can repeat or comma-separate.")
...
func newRestartCmd() *cobra.Command {
	...
	cmd.Flags().StringSliceVar(&runtimeFilters, "runtime", nil, "Only restart or resume daemon-known instances for this runtime: claude, codex, or docker. Can repeat or comma-separate.")
...
func newInspectCmd() *cobra.Command {
	...
	cmd.Flags().StringSliceVar(&runtimeFilters, "runtime", nil, "Only inspect instances for this runtime: claude, codex, or docker. Can repeat or comma-separate.")
...
func newRmCmd() *cobra.Command {
	...
	cmd.Flags().StringSliceVar(&runtimeFilters, "runtime", nil, "Remove daemon-known instances for this runtime: claude, codex, or docker. Can repeat or comma-separate.")
...
func newWaitCmd() *cobra.Command {
	...
	cmd.Flags().StringSliceVar(&runtimeFilters, "runtime", nil, "Wait for daemon-known instances for this runtime: claude, codex, or docker. Can repeat or comma-separate.")
