...
func TestInstanceLs_Empty(t *testing.T) {
	...
	cmd.SetArgs([]string{"instance", "ls", "--repo", tmp})
...
func TestInstanceShow_PrintsFiles(t *testing.T) {
	...
	cmd.SetOut(out)
	cmd.SetErr(&bytes.Buffer{})
	cmd.SetArgs([]string{"instance", "show", "manager", "--repo", tmp})
	if err := cmd.Execute(); err != nil {
...
func TestInspectAlias_PrintsFiles(t *testing.T) {
	...
	cmd.SetOut(out)
	cmd.SetErr(&bytes.Buffer{})
	cmd.SetArgs([]string{"inspect", "manager", "--repo", tmp})
	if err := cmd.Execute(); err != nil {
...
func TestInspectUsesLocalDaemonMetadataWhenDaemonStopped(t *testing.T) {
	...
	cmd.SetOut(out)
	cmd.SetErr(stderr)
	cmd.SetArgs([]string{"inspect", "adhoc", "--json", "--repo", tmp})
	if err := cmd.Execute(); err != nil {
...
`, time.Now())
	...
	cmd.SetOut(out)
	cmd.SetErr(&bytes.Buffer{})
	cmd.SetArgs([]string{"inspect", "manager", "--repo", tmp, "--json"})
	if err := cmd.Execute(); err != nil {
...
`, time.Now())
	...
	cmd.SetOut(out)
	cmd.SetErr(&bytes.Buffer{})
	cmd.SetArgs([]string{"inspect", "manager", "--format", "{{.Instance}}:{{.State.Path}}:{{.Status.Phase}}:{{.Topology.Agent}}", "--repo", tmp})
	if err := cmd.Execute(); err != nil {
...
func TestInspectJSONMultipleEmitsArray(t *testing.T) {
	...
	cmd.SetOut(out)
	cmd.SetErr(&bytes.Buffer{})
	cmd.SetArgs([]string{"inspect", "manager", "worker-1", "--repo", tmp, "--json"})
	if err := cmd.Execute(); err != nil {
...
func TestInspectAllJSONUsesVisibleInstances(t *testing.T) {
	...
	cmd.SetOut(out)
	cmd.SetErr(&bytes.Buffer{})
	cmd.SetArgs([]string{"inspect", "--all", "--repo", tmp, "--json"})
	if err := cmd.Execute(); err != nil {
...
func TestInspectLatestJSONUsesNewestVisibleInstance(t *testing.T) {
	...
	cmd.SetOut(out)
	cmd.SetErr(stderr)
	cmd.SetArgs([]string{"inspect", "--latest", "--json", "--repo", tmp})
	if err := cmd.Execute(); err != nil {
...
func TestInspectLastJSONUsesNewestVisibleInstances(t *testing.T) {
	...
	cmd.SetOut(out)
	cmd.SetErr(stderr)
	cmd.SetArgs([]string{"inspect", "--last", "2", "--json", "--repo", tmp})
	if err := cmd.Execute(); err != nil {
...
func TestInspectLatestHonorsFilters(t *testing.T) {
	...
	cmd.SetOut(out)
	cmd.SetErr(stderr)
	cmd.SetArgs([]string{"inspect", "--latest", "--status", "running", "--json", "--repo", tmp})
	if err := cmd.Execute(); err != nil {
...
`, time.Now())
	...
	cmd.SetOut(out)
	cmd.SetErr(&bytes.Buffer{})
	cmd.SetArgs([]string{"inspect", "--agent", "manager", "--phase", "idle", "--repo", tmp, "--json"})
	if err := cmd.Execute(); err != nil {
...
func TestInspectRuntimeFilterUsesVisibleInstances(t *testing.T) {
	...
	cmd.SetOut(out)
	cmd.SetErr(stderr)
	cmd.SetArgs([]string{"inspect", "--runtime", "codex", "--repo", tmp, "--json"})
	if err := cmd.Execute(); err != nil {
...
`, now)
	...
	cmd.SetOut(out)
	cmd.SetErr(stderr)
	cmd.SetArgs([]string{"inspect", "--unhealthy", "--repo", tmp, "--json"})
	if err := cmd.Execute(); err != nil {
...
func TestInstanceShow_NotFound(t *testing.T) {
	...
	cmd.SetOut(out)
	cmd.SetErr(errOut)
	cmd.SetArgs([]string{"instance", "show", "ghost", "--repo", tmp})
	err := cmd.Execute()
	if err == nil {
...
`)
	...
	cmd.SetOut(out)
	cmd.SetErr(stderr)
	cmd.SetArgs([]string{"instance", "up", "manager", "--fresh", "--json", "--repo", tmp})
...
func TestInstanceUpLastDryRunSelectsNewestStoppedMetadata(t *testing.T) {
	...
	cmd.SetOut(out)
	cmd.SetErr(stderr)
	cmd.SetArgs([]string{"instance", "up", "--last", "2", "--status", "stopped", "--dry-run", "--json", "--repo", tmp})
	if err := cmd.Execute(); err != nil {
	...
	commands.SetArgs([]string{"instance", "up", "--last", "2", "--status", "stopped", "--dry-run", "--commands", "--repo", tmp})
...
`)
	...
	cmd.SetOut(out)
	cmd.SetErr(stderr)
	cmd.SetArgs([]string{"instance", "up", "manager", "--fresh", "--dry-run", "--commands", "--repo", tmp})
	if err := cmd.Execute(); err != nil {
	...
	start.SetArgs([]string{"start", "manager", "--fresh", "--dry-run", "--commands", "--repo", tmp})
...
`)
	...
	cmd.SetOut(out)
	cmd.SetErr(stderr)
	cmd.SetArgs([]string{"instance", "up", "manager", "--fresh", "--force", "--dry-run", "--commands", "--repo", tmp})
	if err := cmd.Execute(); err != nil {
	...
	start.SetOut(startOut)
	start.SetErr(startErr)
	start.SetArgs([]string{"start", "manager", "--fresh", "--force", "--dry-run", "--commands", "--repo", tmp})
	if err := start.Execute(); err != nil {
...
`)
	...
	cmd.SetOut(out)
	cmd.SetErr(stderr)
	cmd.SetArgs([]string{"instance", "up", "manager", "--json", "--repo", tmp})
	if err := cmd.Execute(); err != nil {
...
`)
	...
	mgr := daemon.NewInstanceManager(root, nil) // nil spawner = real child process
	if err := daemon.ReconcileWithTopology(teamDir, mgr, nil); err != nil {
...
func TestInstanceDownLastDryRunSelectsNewestRunningMetadata(t *testing.T) {
	...
	cmd.SetOut(out)
	cmd.SetErr(stderr)
	cmd.SetArgs([]string{"instance", "down", "--last", "2", "--status", "running", "--dry-run", "--json", "--repo", tmp})
	if err := cmd.Execute(); err != nil {
	...
	commands.SetOut(commandsOut)
	commands.SetErr(commandsErr)
	commands.SetArgs([]string{"instance", "down", "--last", "2", "--status", "running", "--dry-run", "--commands", "--rm", "--timeout", "10s", "--repo", tmp})
	if err := commands.Execute(); err != nil {
...
func TestInstanceRm_Force(t *testing.T) {
	...
	cmd.SetOut(out)
	cmd.SetErr(&bytes.Buffer{})
	cmd.SetArgs([]string{"instance", "rm", "ephemeral", "--repo", tmp, "--force"})
	if err := cmd.Execute(); err != nil {
...
func TestInstanceRmRefusesSoleOwnerSkillWithoutForce(t *testing.T) {
	...
	cmd.SetOut(&bytes.Buffer{})
	cmd.SetErr(stderr)
	cmd.SetArgs([]string{"instance", "rm", "ticket-manager", "--repo", tmp})
	err := cmd.Execute()
	if err == nil {
...
func TestRmTopLevel_Force(t *testing.T) {
	...
	cmd.SetOut(out)
	cmd.SetErr(&bytes.Buffer{})
	cmd.SetArgs([]string{"rm", "ephemeral", "--repo", tmp, "--force"})
	if err := cmd.Execute(); err != nil {
...
func TestRmTopLevelDryRunCommands(t *testing.T) {
	...
	cmd.SetOut(out)
	cmd.SetErr(stderr)
	cmd.SetArgs([]string{"rm", "ephemeral", "--repo", tmp, "--force", "--dry-run", "--commands"})
	if err := cmd.Execute(); err != nil {
...
func TestInstanceRmDryRunCommands(t *testing.T) {
	...
	cmd.SetOut(out)
	cmd.SetErr(stderr)
	cmd.SetArgs([]string{"instance", "rm", "ephemeral", "--repo", tmp, "--force", "--dry-run", "--commands"})
	if err := cmd.Execute(); err != nil {
	...
	noAction.SetArgs([]string{"instance", "rm", "--all", "--repo", tmp, "--runtime", "codex", "--dry-run", "--commands"})
...
func TestRmTopLevelJSONForce(t *testing.T) {
	...
	cmd.SetOut(out)
	cmd.SetErr(&bytes.Buffer{})
	cmd.SetArgs([]string{"rm", "ephemeral", "--repo", tmp, "--force", "--json"})
	if err := cmd.Execute(); err != nil {
...
func TestRmTopLevelFormatForce(t *testing.T) {
	...
	cmd.SetOut(out)
	cmd.SetErr(&bytes.Buffer{})
	cmd.SetArgs([]string{"rm", "ephemeral", "--repo", tmp, "--force", "--format", "{{.Instance}}:{{.Removed}}:{{.StateRemoved}}:{{.Path}}"})
	if err := cmd.Execute(); err != nil {
...
func TestRmLastDryRunSelectsNewestLocalMetadata(t *testing.T) {
	...
	cmd.SetOut(out)
	cmd.SetErr(stderr)
	cmd.SetArgs([]string{"rm", "--last", "2", "--status", "stopped", "--dry-run", "--json", "--repo", tmp})
	if err := cmd.Execute(); err != nil {
...
func TestInstanceRmLatestDryRunSelectsNewestMatchingAgent(t *testing.T) {
	...
	cmd.SetOut(out)
	cmd.SetErr(stderr)
	cmd.SetArgs([]string{"instance", "rm", "--latest", "--agent", "manager", "--dry-run", "--json", "--repo", tmp})
	if err := cmd.Execute(); err != nil {
...
func TestRmTopLevelQuietForceSuppressesOutput(t *testing.T) {
	...
	cmd.SetOut(out)
	cmd.SetErr(stderr)
	cmd.SetArgs([]string{"rm", "ephemeral", "--repo", tmp, "--force", "--quiet"})
	if err := cmd.Execute(); err != nil {
...
func TestRmAllForceJSONRemovesMatchingAgent(t *testing.T) {
	...
	cmd.SetOut(out)
	cmd.SetErr(stderr)
	cmd.SetArgs([]string{"rm", "--all", "--agent", "manager", "--force", "--json", "--repo", tmp})
	if err := cmd.Execute(); err != nil {
...
func TestRmRuntimeDryRunJSONUsesLocalMetadata(t *testing.T) {
	...
	for _, args := range [][]string{
		{"rm", "--runtime", "codex", "--dry-run", "--json", "--repo", tmp},
		{"instance", "rm", "--runtime", "codex", "--dry-run", "--json", "--repo", tmp},
	} {
		cmd := NewRootCmd()
		out, stderr := &bytes.Buffer{}, &bytes.Buffer{}
		cmd.SetOut(out)
	...
	bad.SetErr(&badErr)
	bad.SetArgs([]string{"rm", "--runtime", "llama", "--dry-run", "--repo", tmp})
...
func TestRmSummaryJSONDryRun(t *testing.T) {
	...
	cmd.SetOut(out)
	cmd.SetErr(stderr)
	cmd.SetArgs([]string{"rm", "--all", "--dry-run", "--summary", "--json", "--repo", tmp})
	if err := cmd.Execute(); err != nil {
...
func TestInstanceRmSummaryTextSuppressesRows(t *testing.T) {
	...
	cmd.SetOut(out)
	cmd.SetErr(stderr)
	cmd.SetArgs([]string{"instance", "rm", "--all", "--dry-run", "--summary", "--repo", tmp})
	if err := cmd.Execute(); err != nil {
...
func TestPruneQuietSuppressesOutput(t *testing.T) {
	...
	cmd.SetOut(out)
	cmd.SetErr(stderr)
	cmd.SetArgs([]string{"prune", "--quiet", "--repo", tmp})
	if err := cmd.Execute(); err != nil {
...
func TestPruneFormatPrintsRemovalRows(t *testing.T) {
	...
	cmd.SetOut(out)
	cmd.SetErr(stderr)
	cmd.SetArgs([]string{"prune", "--format", "{{.Instance}}:{{.Path}}", "--repo", tmp})
	if err := cmd.Execute(); err != nil {
...
func TestPruneDryRunJSONDoesNotRemoveFinished(t *testing.T) {
	...
	cmd.SetOut(out)
	cmd.SetErr(stderr)
	cmd.SetArgs([]string{"prune", "--dry-run", "--json", "--repo", tmp})
	if err := cmd.Execute(); err != nil {
...
func TestPruneOlderThanDryRunJSONOnlyMatchesOldFinished(t *testing.T) {
	...
	cmd.SetOut(out)
	cmd.SetErr(stderr)
	cmd.SetArgs([]string{"prune", "--dry-run", "--json", "--older-than", "24h", "--repo", tmp})
	if err := cmd.Execute(); err != nil {
...
func TestPruneUsesLocalMetadataWhenDaemonStopped(t *testing.T) {
	...
	cmd.SetOut(out)
	cmd.SetErr(stderr)
	cmd.SetArgs([]string{"prune", "--json", "--repo", tmp})
	if err := cmd.Execute(); err != nil {
...
func TestPruneSummaryJSONUsesLocalMetadataWhenDaemonStopped(t *testing.T) {
	...
	cmd.SetOut(out)
	cmd.SetErr(stderr)
	cmd.SetArgs([]string{"prune", "--summary", "--json", "--repo", tmp})
	if err := cmd.Execute(); err != nil {
...
func TestPrunePhaseUsesLocalStatusWhenDaemonStopped(t *testing.T) {
	...
	cmd.SetOut(out)
	cmd.SetErr(stderr)
	cmd.SetArgs([]string{"prune", "--phase", "done", "--json", "--repo", tmp})
	if err := cmd.Execute(); err != nil {
...
func TestPruneStatusNarrowsFinishedInstances(t *testing.T) {
	...
	cmd.SetOut(out)
	cmd.SetErr(stderr)
	cmd.SetArgs([]string{"prune", "--status", "crashed", "--json", "--repo", tmp})
	if err := cmd.Execute(); err != nil {
...
func TestPruneRuntimeNarrowsFinishedInstances(t *testing.T) {
	...
	cmd.SetOut(out)
	cmd.SetErr(stderr)
	cmd.SetArgs([]string{"prune", "--runtime", "codex", "--dry-run", "--json", "--repo", tmp})
	if err := cmd.Execute(); err != nil {
	...
	commands.SetOut(commandsOut)
	commands.SetErr(commandsErr)
	commands.SetArgs([]string{"prune", "--runtime", "codex", "--status", "crashed", "--dry-run", "--commands", "--repo", tmp})
	if err := commands.Execute(); err != nil {
...
func TestPruneDryRunCommandsNoActionIsSilent(t *testing.T) {
	...
	cmd.SetOut(out)
	cmd.SetErr(stderr)
	cmd.SetArgs([]string{"prune", "--repo", tmp, "--dry-run", "--commands"})
	if err := cmd.Execute(); err != nil {
...
func TestPruneStaleNarrowsFinishedInstances(t *testing.T) {
	...
	cmd.SetOut(out)
	cmd.SetErr(stderr)
	cmd.SetArgs([]string{"prune", "--stale", "--json", "--repo", tmp})
	if err := cmd.Execute(); err != nil {
...
func TestPruneUnhealthyNarrowsFinishedInstances(t *testing.T) {
	...
	cmd.SetOut(out)
	cmd.SetErr(stderr)
	cmd.SetArgs([]string{"prune", "--unhealthy", "--json", "--repo", tmp})
	if err := cmd.Execute(); err != nil {
...
func TestPruneRuntimeStaleNarrowsDeadRecordedPIDs(t *testing.T) {
	...
	cmd.SetOut(out)
	cmd.SetErr(stderr)
	cmd.SetArgs([]string{"prune", "--runtime-stale", "--dry-run", "--json", "--repo", tmp})
	if err := cmd.Execute(); err != nil {
...
func TestRmFinishedNoLocalMetadataNoops(t *testing.T) {
	...
	cmd.SetOut(out)
	cmd.SetErr(stderr)
	cmd.SetArgs([]string{"rm", "--finished", "--repo", tmp})
	if err := cmd.Execute(); err != nil {
...
func TestRmAllNoLocalMetadataNoops(t *testing.T) {
	...
	cmd.SetOut(out)
	cmd.SetErr(stderr)
	cmd.SetArgs([]string{"rm", "--all", "--force", "--json", "--repo", tmp})
	if err := cmd.Execute(); err != nil {
		t.Fatalf("rm --all: %v\nstderr=%s", err, stderr.String())
	}
	if got := strings.TrimSpace(out.String()); got != "[]" {
...
func TestRmStatusUsesLocalMetadataWhenDaemonStopped(t *testing.T) {
	...
	cmd.SetOut(out)
	cmd.SetErr(stderr)
	cmd.SetArgs([]string{"rm", "--status", "stopped", "--force", "--json", "--repo", tmp})
	if err := cmd.Execute(); err != nil {
...
func TestRmPhaseUsesLocalStatusWhenDaemonStopped(t *testing.T) {
	...
	cmd.SetOut(out)
	cmd.SetErr(stderr)
	cmd.SetArgs([]string{"rm", "--phase", "done", "--force", "--json", "--repo", tmp})
	if err := cmd.Execute(); err != nil {
...
func TestRmStaleUsesLocalStatusWhenDaemonStopped(t *testing.T) {
	...
	cmd.SetOut(out)
	cmd.SetErr(stderr)
	cmd.SetArgs([]string{"rm", "--stale", "--agent", "manager", "--dry-run", "--json", "--repo", tmp})
	if err := cmd.Execute(); err != nil {
...
func TestRmUnhealthyUsesLocalStatusWhenDaemonStopped(t *testing.T) {
	...
	cmd.SetOut(out)
	cmd.SetErr(stderr)
	cmd.SetArgs([]string{"rm", "--unhealthy", "--agent", "manager", "--dry-run", "--json", "--repo", tmp})
	if err := cmd.Execute(); err != nil {
...
func TestInstanceRm_AbortedWithoutConfirm(t *testing.T) {
	...
	cmd.SetErr(&bytes.Buffer{})
	cmd.SetIn(bytes.NewBufferString("\n")) // empty answer → abort
	cmd.SetArgs([]string{"instance", "rm", "keep", "--repo", tmp})
	if err := cmd.Execute(); err != nil {
