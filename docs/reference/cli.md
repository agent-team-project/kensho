...
| `agent-team snapshot diff <before.json> <after.json>` | Compare saved diagnostic artifacts, including provenance, git context, instances, jobs, inboxes, queue, schedules, intake, events, and pipeline state |
